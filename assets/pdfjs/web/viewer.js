...
var PDFViewerApplication = {
  ...
  bindWindowEvents: function pdfViewBindWindowEvents() {
	...
	function webViewerInitialized() {
	    ...
	    /* file = "/courses/public/tmp/" + file; //修改 */
    ...
    _bindHandToolListener: function SecondaryToolbar_bindHandToolListener(toggleHandToolButton) {
      ...
      this.eventBus.on('handtoolchanged', function (e) {
        ...
        if (isHandToolActive) {
          ...
          toggleHandToolButton.firstElementChild.textContent = _ui_utils.mozL10n.get('hand_tool_disable_label', null, 'Disable');
        } else {
          toggleHandToolButton.title = _ui_utils.mozL10n.get('hand_tool_enable.title', null, 'Enable hand tool');
          toggleHandToolButton.firstElementChild.textContent = _ui_utils.mozL10n.get('hand_tool_enable_label', null, 'Enable');
        }
      });
    },
